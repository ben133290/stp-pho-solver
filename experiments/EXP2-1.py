...
exp.add_algorithm("All", get_repo(), "c60f22bcf7b34983c5f157f96a8bf6557efe00be", "Release",
...
exp.add_algorithm("indTB", get_repo(), "c60f22bcf7b34983c5f157f96a8bf6557efe00be", "Release",
                  (build_pattern_string("1 2 3 4 5 6 7") + build_pattern_string("8 9 10 11 12 13 14 15") +
                   "--pdbPathPrefix /infai/heuser0000/stp-pho-solver/PDBFILES/").split())

exp.add_algorithm("indLR", get_repo(), "c60f22bcf7b34983c5f157f96a8bf6557efe00be", "Release",
                  (build_pattern_string("1 4 5 8 9 12 13") + build_pattern_string("2 3 6 7 10 11 14 15") +
                   "--pdbPathPrefix /infai/heuser0000/stp-pho-solver/PDBFILES/").split())

exp.add_algorithm("indCH", get_repo(), "c60f22bcf7b34983c5f157f96a8bf6557efe00be", "Release",
                  (build_pattern_string("1 4 5 10 11 14 15") + build_pattern_string("2 3 6 7 8 9 12 13") +
                   "--pdbPathPrefix /infai/heuser0000/stp-pho-solver/PDBFILES/").split())

"""
exp.add_algorithm("Rows+Cols", get_repo(), "c60f22bcf7b34983c5f157f96a8bf6557efe00be", "Release",
                  (add_pattern("1 2 3 8 9 10 11") + add_pattern("4 5 6 7 12 13 14 15") +
                   add_pattern("2 4 6 8 10 12 14") + add_pattern("1 3 5 7 9 11 13 15") +
                   "--pdbPathPrefix /infai/heuser0000/stp-pho-solver/PDBFILES/").split())

exp.add_algorithm("Checkers", get_repo(), "c60f22bcf7b34983c5f157f96a8bf6557efe00be", "Release",
                  (add_pattern("2 5 7 8 10 13 15") + add_pattern("1 3 4 6 9 11 12 14") +
                   add_pattern("1 4 5 10 11 14 15") + add_pattern("2 3 6 7 8 9 12 13") +
                   "--pdbPathPrefix /infai/heuser0000/stp-pho-solver/PDBFILES/").split())
"""

exp.add_tasks(get_korf_for_range(10, 20))
